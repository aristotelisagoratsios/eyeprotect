...
! function() {
    ...
    function t(o) {
        if (!o) throw new Error("No options passed to MPCwaypoint constructor");
        if (!o.element) throw new Error("No element option passed to MPCwaypoint constructor");
        if (!o.handler) throw new Error("No handler option passed to MPCwaypoint constructor");
        this.key = "MPCwaypoint-" + e, this.options = t.Adapter.extend({}, t.defaults, o), this.element = this.options.element, this.adapter = new t.Adapter(this.element), this.callback = o.handler, this.axis = this.options.horizontal ? "horizontal" : "vertical", this.enabled = this.options.enabled, this.triggerPoint = null, this.group = t.Group.findOrCreate({
...
function() {
    ...
    function e(t) {
        this.element = t, this.Adapter = n.Adapter, this.adapter = new this.Adapter(t), this.key = "MPCwaypoint-context-" + i, this.didScroll = !1, this.didResize = !1, this.oldScroll = {
            x: this.adapter.scrollLeft(),
            y: this.adapter.scrollTop()
        }, this.MPCwaypoints = {
            vertical: {},
            horizontal: {}
        }, t.MPCwaypointContextKey = this.key, o[t.MPCwaypointContextKey] = this, i += 1, this.createThrottledScrollHandler(), this.createThrottledResizeHandler()
    }
    var i = 0,
        o = {},
        n = window.MPCwaypoint,
        r = window.onload;
    e.prototype.add = function(t) {
        var e = t.options.horizontal ? "horizontal" : "vertical";
        this.MPCwaypoints[e][t.key] = t, this.refresh()
    }, e.prototype.checkEmpty = function() {
        var t = this.Adapter.isEmptyObject(this.MPCwaypoints.horizontal),
            e = this.Adapter.isEmptyObject(this.MPCwaypoints.vertical);
        t && e && (this.adapter.off(".MPCwaypoints"), delete o[this.key])
    }, e.prototype.createThrottledResizeHandler = function() {
        function t() {
            e.handleResize(), e.didResize = !1
        }
        var e = this;
        this.adapter.on("resize.MPCwaypoints", function() {
        ...
        var e = this;
        this.adapter.on("scroll.MPCwaypoints", function() {
        ...
        for (var i in e) {
            ...
            for (var s in this.MPCwaypoints[i]) {
                var a = this.MPCwaypoints[i][s],
        ...
        delete this.MPCwaypoints[t.axis][t.key], this.checkEmpty()
    }, e.prototype.innerWidth = function() {
        return this.element == this.element.window ? n.viewportWidth() : this.adapter.innerWidth()
    }, e.prototype.destroy = function() {
        var t = [];
        for (var e in this.MPCwaypoints)
            for (var i in this.MPCwaypoints[e]) t.push(this.MPCwaypoints[e][i]);
        ...
        for (var r in t) {
            var s = t[r];
            for (var a in this.MPCwaypoints[r]) {
                var l, h, p, u, c, d = this.MPCwaypoints[r][a],
                    f = d.options.offset,
                    w = d.triggerPoint,
                    y = 0,
                    g = null == w;
        ...
        return o[t.MPCwaypointContextKey]
...
function() {
    ...
    function i(t) {
        this.name = t.name, this.axis = t.axis, this.id = this.name + "-" + this.axis, this.MPCwaypoints = [], this.clearTriggerQueues(), o[this.axis][this.name] = this
    }
    var o = {
            vertical: {},
            horizontal: {}
    ...
    i.prototype.add = function(t) {
        ...
        this.MPCwaypoints.sort(t);
        var i = n.Adapter.inArray(e, this.MPCwaypoints),
            o = i === this.MPCwaypoints.length - 1;
        return o ? null : this.MPCwaypoints[i + 1]
    }, i.prototype.previous = function(e) {
        this.MPCwaypoints.sort(t);
        var i = n.Adapter.inArray(e, this.MPCwaypoints);
        return i ? this.MPCwaypoints[i - 1] : null
    }, i.prototype.queueTrigger = function(t, e) {
        this.triggerQueues[e].push(t)
    }, i.prototype.remove = function(t) {
        var e = n.Adapter.inArray(t, this.MPCwaypoints);
        e > -1 && this.MPCwaypoints.splice(e, 1)
    }, i.prototype.first = function() {
        return this.MPCwaypoints[0]
    }, i.prototype.last = function() {
        return this.MPCwaypoints[this.MPCwaypoints.length - 1]
...
function() {
    ...
    var e = window.MPCwaypoint;
    window.jQuery && (window.jQuery.fn.MPCwaypoint = t(window.jQuery)), window.Zepto && (window.Zepto.fn.MPCwaypoint = t(window.Zepto))
}();
/*!
...
! function() {
    ...
    function e(t) {
        this.options = i.Adapter.extend({}, e.defaults, t), this.axis = this.options.horizontal ? "horizontal" : "vertical", this.MPCwaypoints = [], this.element = this.options.element, this.createMPCwaypoints()
    }
    var i = window.MPCwaypoint;
    e.prototype.createMPCwaypoints = function() {
        for (var t = {
                vertical: [{
                    down: "enter",
                    up: "exited",
            ...
            var n = t[this.axis][e];
            this.createMPCwaypoint(n)
        }
    }, e.prototype.createMPCwaypoint = function(t) {
        var e = this;
        this.MPCwaypoints.push(new i({
        ...
        for (var t = 0, e = this.MPCwaypoints.length; e > t; t++) this.MPCwaypoints[t].destroy();
        this.MPCwaypoints = []
    }, e.prototype.disable = function() {
        for (var t = 0, e = this.MPCwaypoints.length; e > t; t++) this.MPCwaypoints[t].disable()
    }, e.prototype.enable = function() {
        for (var t = 0, e = this.MPCwaypoints.length; e > t; t++) this.MPCwaypoints[t].enable()
    }, e.defaults = {
        context: window,
        enabled: !0,
        enter: t,
