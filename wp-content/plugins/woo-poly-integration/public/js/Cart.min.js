jQuery(function(e) {
    ...
    var n = {
        ...
        success: function(r) {
            r && r.fragments && (e.each(r.fragments, function(t, r) {
                e(t).replaceWith(r)
            }), t && (sessionStorage.setItem(wc_cart_fragments_params.fragment_name, JSON.stringify(r.fragments)), o(r.cart_hash), r.cart_hash && a()), e(document.body).trigger("wc_fragments_refreshed"))
        },
        error: function() {
    ...
    if (t) {
        ...
        e(document.body).on("wc_fragment_refresh updated_wc_div", function() {
            ...
            null != s && "" !== s || a(), sessionStorage.setItem(wc_cart_fragments_params.fragment_name, JSON.stringify(t)), o(n)
        ...
        try {
            var c = JSON.parse(sessionStorage.getItem(wc_cart_fragments_params.fragment_name)),
                g = sessionStorage.getItem(r),
                _ = Cookies.get("woocommerce_cart_hash"),
                m = sessionStorage.getItem("wc_cart_created");
            if (null != g && "" !== g || (g = ""), null != _ && "" !== _ || (_ = ""), g && (null == m || "" === m)) throw "No cart_created";
            if (m) {
                var d = 1 * m + 864e5,
                    w = (new Date).getTime();
            ...
            if (!c || !c["div.widget_shopping_cart_content"] || g !== _) throw "No fragment";
            e.each(c, function(t, r) {
                e(t).replaceWith(r)
            }), e(document.body).trigger("wc_fragments_loaded");
            var f = sessionStorage.getItem("pll_language"),
                u = function() {
                    var t = e.cookie("pll_language");
                    return null != t && "" !== t || (t = ""), t
                }();
            if (null != f && "" !== f || (f = ""), !u) throw "Language not found";
            if (!f || f !== u) throw sessionStorage.setItem("pll_language", u), "Language changed"
        } catch (e) {
            s()
        }
    } else s();
