! function(e) {
    ...
    function p(e, t) {
        f.ev.triggerHandler(I + e, t), f.st.callbacks && (e = e.charAt(0).toLowerCase() + e.slice(1), f.st.callbacks[e]) && f.st.callbacks[e].apply(f, c.isArray(t) ? t : [t])
    }

    function m(e) {
        return e === A && f.currTemplate.closeBtn || (f.currTemplate.closeBtn = c(f.st.closeMarkup.replace("%title%", f.st.tClose)), A = e), f.currTemplate.closeBtn
    }
    ...
    var f, i, g, s, h, A, l, v, y, n, C = "Close",
        F = "BeforeClose",
        w = "MarkupParse",
        b = "Open",
        j = "Change",
        ...
        S = (c.magnificPopup = {
            ...
            proto: e.prototype = {
                ...
                open: function(e) {
                    ...
                    if (!f.isOpen) {
                        ...
                        p("BeforeOpen"), f.st.showCloseBtn && (f.st.closeBtnInside ? (d(w, function(e, t, n, i) {
                ...
                updateStatus: function(e, t) {
                    var n;
                    f.preloader && (i !== e && f.container.removeClass("mfp-s-" + i), n = {
                        status: e,
                ...
                _parseMarkup: function(o, e, t) {
                    var a;
                    t.data && (e = c.extend(t.data, e)), p(w, [o, e, t]), c.each(e, function(e, t) {
                        if (void 0 === t || !1 === t) return !0;
                        var n, i;
                        1 < (a = e.split("_")).length ? 0 < (n = o.find(x + "-" + a[0])).length && ("replaceWith" === (i = a[1]) ? n[0] !== t[0] && n.replaceWith(t) : "img" === i ? n.is("img") ? n.attr("src", t) : n.replaceWith(c("<img>").attr("src", t).attr("class", n.attr("class"))) : n.attr(a[1], t)) : o.find(x + "-" + e).html(t)
                    })
                },
            ...
            a();
            var t, n, i, o = c(this);
            return "string" == typeof e ? "open" === e ? (t = _ ? o.data("magnificPopup") : o[0].magnificPopup, n = parseInt(arguments[1], 10) || 0, i = t.items ? t.items[n] : (i = o, (i = t.delegate ? i.find(t.delegate) : i).eq(n)), f._openClick({
                mfpEl: i
            }, o, t)) : f.isOpen && f[e].apply(f, Array.prototype.slice.call(arguments, 1)) : (e = c.extend(!0, {}, e), _ ? o.data("magnificPopup", e) : o[0].magnificPopup = e, f.addGroup(o, e)), o
        }, "inline"),
        E = (c.magnificPopup.registerModule(S, {
            ...
            proto: {
                ...
                getInline: function(e, t) {
                    var n, i, o;
                    return r(), e.src ? (n = f.st.inline, (i = c(e.src)).length ? ((o = i[0].parentNode) && o.tagName && (v || (l = n.hiddenClass, v = u(l), l = "mfp-" + l), y = i.after(v).detach().removeClass(l)), f.updateStatus("ready")) : (f.updateStatus("error", n.tNotFound), i = c("<div>")), e.inlineElement = i) : (f.updateStatus("ready"), f._parseMarkup(t, {}, e), t)
                }
            }
        }), "ajax");
            ...
            getAjax: function(i) {
                ...
                var e = c.extend({
                    ...
                    success: function(e, t, n) {
                        ...
                        p("ParseAjax", e), f.appendContent(c(e.data), E), i.finished = !0, o(), f._setFocus(), setTimeout(function() {
                            f.wrap.addClass(k)
                        }, 16), f.updateStatus("ready"), p("AjaxContentAdded")
                    },
                    error: function() {
                        o(), i.finished = i.loadError = !0, f.updateStatus("error", f.st.ajax.tError.replace("%url%", i.src))
                    }
                }, f.st.ajax.settings);
    ...
    c.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            findImageSize: function(t) {
                function n(e) {
                    z && clearInterval(z), z = setInterval(function() {
                        0 < o.naturalWidth ? f._onImageHasSize(t) : (200 < i && clearInterval(z), 3 === ++i ? n(10) : 40 === i ? n(50) : 100 === i && n(500))
                    }, e)
                }
                var i = 0,
                    o = t.img[0];
            ...
            getImage: function(e, t) {
                function n() {
                    e && (e.img[0].complete ? (e.img.off(".mfploader"), e === f.currItem && (f._onImageHasSize(e), f.updateStatus("ready")), e.hasSize = !0, e.loaded = !0, p("ImageLoadComplete")) : ++a < 200 ? setTimeout(n, 100) : i())
                }
                ...
                var o, a = 0,
                    r = f.st.image,
                    s = t.find(".mfp-img");
                return s.length && ((o = document.createElement("img")).className = "mfp-img", e.el && e.el.find("img").length && (o.alt = e.el.find("img").attr("alt")), e.img = c(o).on("load.mfploader", n).on("error.mfploader", i), o.src = e.src, s.is("img") && (e.img = e.img.clone()), 0 < (o = e.img[0]).naturalWidth ? e.hasSize = !0 : o.width || (e.hasSize = !1)), f._parseMarkup(t, {
                    title: function(e) {
    ...
    function O(e) {
        var t;
        f.currTemplate[L] && (t = f.currTemplate[L].find("iframe")).length && (e || (t[0].src = "//about:blank"), f.isIE8) && t.css("display", e ? "block" : "none")
    }
        ...
        proto: {
            initZoom: function() {
                ...
                r.enabled && f.supportsTransition && (t = r.duration, n = function(e) {
                    ...
                    f._allowZoom() && (clearTimeout(o), f.content.css("visibility", "hidden"), (e = f._getItemToZoom()) ? ((a = n(e)).css(f._getOffset()), f.wrap.append(a), o = setTimeout(function() {
                        a.css(f._getOffset(!0)), o = setTimeout(function() {
                    ...
                    f._allowZoom() && (i(), a && a.remove(), e = null)
                }))
            },
            _allowZoom: function() {
            ...
            _getOffset: function(e) {
                var e = e ? f.currItem.img : f.st.zoom.opener(f.currItem.el || f.currItem),
                    ...
                    e = (t.top -= c(window).scrollTop() - n, {
                        width: e.width(),
                        height: (_ ? e.innerHeight() : e[0].offsetHeight) - i - n
                    });
    ...
    var B, L = "iframe",
        H = (c.magnificPopup.registerModule(L, {
            ...
            proto: {
                initIframe: function() {
                    f.types.push(L), d("BeforeChange", function(e, t, n) {
                        t !== n && (t === L ? O() : n === L && O(!0))
                    }), d(C + "." + L, function() {
                        O()
                    })
            ...
            proto: {
                initGallery: function() {
                    ...
                    h += " mfp-gallery", d(b + e, function() {
                        ...
                        n.counter = 1 < o ? W(a.tCounter, i.index, o) : ""
    ...
    c.magnificPopup.registerModule(H, {
        ...
        proto: {
            initRetina: function() {
                var n, i;
                1 < window.devicePixelRatio && (n = f.st.retina, i = n.ratio, 1 < (i = isNaN(i) ? i() : i)) && (d("ImageHasSize." + H, function(e, t) {
                    t.img.css({
