...
! function(t) {
    ...
    "use strict";
    var s, o, n, l, r, h, c, a, p, d, u, g, f, v, S;
    a = {
        paneClass: "nano-pane",
        ...
        windowContext: null
    }, r = "scroll", h = "up", n = "DOMMouseScroll", s = "Microsoft Internet Explorer" === e.navigator.appName && /msie 7./i.test(e.navigator.appVersion) && e.ActiveXObject, o = null, g = e.requestAnimationFrame, c = e.cancelAnimationFrame, v = i.createElement("div").style, S = function() {
        var t, e, i, s;
        for (t = i = 0, s = (e = ["t", "webkitT", "MozT", "msT", "OT"]).length; i < s; t = ++i)
            if (e[t], e[t] + "ransform" in v) return e[t].substr(0, e[t].length - 1);
        return !1
    }(), f = function(t) {
        return !1 !== S && ("" === S ? t : S + t.charAt(0).toUpperCase() + t.substr(1))
    }("transform"), d = !1 !== f, p = function() {
        var t, e, s;
        return (e = (t = i.createElement("div")).style).position = "absolute", e.width = "100px", e.height = "100px", e.overflow = r, e.top = "-9999px", i.body.appendChild(t), s = t.offsetWidth - t.clientWidth, i.body.removeChild(t), s
    }, u = function() {
        var t, i, s;
        ...
        return l.prototype.preventScrolling = function(t, e) {
            if (this.isActive)
                if (t.type === n)("down" === e && t.originalEvent.detail > 0 || e === h && t.originalEvent.detail < 0) && t.preventDefault();
                else if ("mousewheel" === t.type) {
                if (!t.originalEvent || !t.originalEvent.wheelDelta) return;
                ("down" === e && t.originalEvent.wheelDelta < 0 || e === h && t.originalEvent.wheelDelta > 0) && t.preventDefault()
            }
            ...
            var t, e;
            d ? (t = {})[f] = "translate(0, " + this.sliderTop + "px)" : t = {
                top: this.sliderTop
            }, g ? (c && this.scrollRAF && c(this.scrollRAF), this.scrollRAF = g((e = this, function() {
            ...
            this.events = {
                down: (t = this, function(e) {
                    return t.isBeingDragged = !0, t.offsetY = e.pageY - t.slider.offset().top, t.slider.is(e.target) || (t.offsetY = 0), t.pane.addClass(t.options.activeClass), t.doc.bind("mousemove", t.events.drag).bind("mouseup", t.events.up), t.body.bind("mouseenter", t.events.enter), !1
                }),
                drag: function(t) {
                    return function(e) {
                ...
                up: function(t) {
                    return function(e) {
                        return t.isBeingDragged = !1, t.pane.removeClass(t.options.activeClass), t.doc.unbind("mousemove", t.events.drag).unbind("mouseup", t.events.up), t.body.unbind("mouseenter", t.events.enter), !1
                    }
                }(this),
                resize: function(t) {
                    return function(e) {
            ...
            var t;
            this.removeEvents(), t = this.events, this.options.disableResize || this.win.bind("resize", t.resize), this.iOSNativeScrolling || (this.slider.bind("mousedown", t.down), this.pane.bind("mousedown", t.panedown).bind("mousewheel " + n, t.wheel)), this.$content.bind("scroll mousewheel " + n + " touchmove", t.scroll)
        }, l.prototype.removeEvents = function() {
            var t;
            t = this.events, this.win.unbind("resize", t.resize), this.iOSNativeScrolling || (this.slider.unbind(), this.pane.unbind()), this.$content.unbind("scroll mousewheel " + n + " touchmove", t.scroll)
        }, l.prototype.generate = function() {
            var i, s, n, l, r;
            return l = (s = this.options).paneClass, r = s.sliderClass, s.contentClass, (n = this.$el.children("." + l)).length || n.children("." + r).length || this.$el.append('<div class="' + l + '"><div class="' + r + '" /></div>'), this.pane = this.$el.children("." + l), this.slider = this.pane.find("." + r), 0 === o && u() ? i = {
                right: -14,
                paddingRight: +e.getComputedStyle(this.content, null).getPropertyValue("padding-right").replace(/[^0-9.]+/g, "") + 14
            } : o && (i = t("body").hasClass("rtl") ? {
                left: -o
            } : {
                right: -o
            }), this.$el.addClass(s.enabledClass), null != i && this.$content.css(i), this
        }, l.prototype.restore = function() {
            this.stopped = !1, this.iOSNativeScrolling || this.pane.show(), this.addEvents()
        }, l.prototype.reset = function() {
            var t, e, i, n, l, h, c, a, p, d, u;
            if (!this.iOSNativeScrolling) {
                if (this.$el.find("." + this.options.paneClass).length || this.generate().stop(), this.stopped && this.restore(), l = (n = (t = this.content).style).overflowY, s && this.$content.css({
                        height: this.$content.height()
                    }), e = t.scrollHeight + o, (p = parseInt(this.$el.css("max-height"), 10)) > 0 && (this.$el.height(""), this.$el.height(t.scrollHeight > p ? p : t.scrollHeight)), c = (h = this.pane.outerHeight(!1)) + (a = parseInt(this.pane.css("top"), 10)) + parseInt(this.pane.css("bottom"), 10), (u = Math.round(c / e * h)) < this.options.sliderMinHeight ? u = this.options.sliderMinHeight : null != this.options.sliderMaxHeight && u > this.options.sliderMaxHeight && (u = this.options.sliderMaxHeight), l === r && n.overflowX !== r && (u += o), this.maxSliderTop = c - u, this.contentHeight = e, this.paneHeight = h, this.paneOuterHeight = c, this.sliderHeight = u, this.paneTop = a, this.slider.height(u), this.events.scroll(), this.pane.show(), this.isActive = !0, t.scrollHeight === t.clientHeight || this.pane.outerHeight(!0) >= t.scrollHeight && l !== r ? (this.pane.hide(), this.isActive = !1) : this.el.clientHeight === t.scrollHeight && l === r ? this.slider.hide() : this.slider.show(), this.pane.css({
                        opacity: this.options.alwaysVisible ? 1 : "",
                        visibility: this.options.alwaysVisible ? "visible" : ""
                    }), "static" === (i = this.$content.css("position")) || "relative" === i) {
                    d = parseInt(this.$content.css("right"), 10);
                    var g = parseInt(this.$content.css("left"), 10);
                    d ? this.$content.css({
                        right: "",
                        marginRight: d
                    }) : g && this.$content.css({
        ...
        }, l.prototype.scrollBottom = function(t) {
            if (this.isActive) return this.$content.scrollTop(this.contentHeight - this.$content.height() - t).trigger("mousewheel"), this.stop().restore(), this
        }, l.prototype.scrollTop = function(t) {
            if (this.isActive) return this.$content.scrollTop(+t).trigger("mousewheel"), this.stop().restore(), this
        }, l.prototype.scrollTo = function(t) {
        ...
        return this.each(function() {
            var i, s;
            if ((s = this.nanoscroller) || (i = t.extend({}, a, e), this.nanoscroller = s = new l(this, i)), e && "object" == typeof e) {
    ...
    }, t.fn.nanoScroller.Constructor = l
});