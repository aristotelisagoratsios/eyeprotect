! function(d, a) {
    ...
    s.prototype.init = function() {
        var e, s = this,
            t = d(this.element),
            o = this.settings,
            n = (o.duplicate ? s.mobileNav = t.clone() : s.mobileNav = t, o.removeIds && (s.mobileNav.removeAttr("id"), s.mobileNav.find("*").each(function(e, t) {
                d(t).removeAttr("id")
            })), o.removeClasses && (s.mobileNav.removeAttr("class"), s.mobileNav.find("*").each(function(e, t) {
                d(t).removeAttr("class")
            })), o.removeStyles && (s.mobileNav.removeAttr("style"), s.mobileNav.find("*").each(function(e, t) {
                d(t).removeAttr("style")
            })), t = u + "_icon", "" === o.label && (t += " " + u + "_no-text"), "a" == o.parentTag && (o.parentTag = 'a href="#"'), s.mobileNav.attr("class", u + "_nav"), e = d('<div class="' + u + '_menu"></div>'), "" !== o.brand && (n = d('<div class="' + u + '_brand">' + o.brand + "</div>"), d(e).append(n)), s.btn = d(["<" + o.parentTag + ' aria-label="mobile menu icon" aria-haspopup="true" role="button" tabindex="0" class="' + u + "_btn " + u + '_collapsed">', '<span class="' + u + '_menutxt">' + o.label + "</span>", '<span class="' + t + '">', '<span class="' + u + '_icon-bar"></span>', '<span class="' + u + '_icon-bar"></span>', '<span class="' + u + '_icon-bar"></span>', "</span>", "</" + o.parentTag + ">"].join("")), d(e).append(s.btn), "" !== o.appendTo ? d(o.appendTo).append(e) : d(o.prependTo).prepend(e), e.append(s.mobileNav), s.mobileNav.find("li"));
        d(n).each(function() {
            var e, t, n, a = d(this),
                i = {};
            i.children = a.children("ul").attr("role", "menu"), a.data("menu", i), 0 < i.children.length ? (i = a.contents(), e = !1, t = [], d(i).each(function() {
                if (d(this).is("ul")) return !1;
                t.push(this), d(this).is("a") && (e = !0)
            }), i = d("<" + o.parentTag + ' role="menuitem" aria-haspopup="true" tabindex="-1" class="' + u + '_item"/>'), o.allowParentLinks && !o.nestedParentLinks && e ? d(t).wrapAll('<span class="' + u + "_parent-link " + u + '_row"/>').parent() : d(t).wrapAll(i).parent().addClass(u + "_row"), o.showChildren ? a.addClass(u + "_open") : a.addClass(u + "_collapsed"), a.addClass(u + "_parent"), n = d('<span class="' + u + '_arrow">' + (o.showChildren ? o.openedSymbol : o.closedSymbol) + "</span>"), o.allowParentLinks && !o.nestedParentLinks && e && (n = n.wrap(i).parent()), d(t).last().after(n)) : 0 === a.children().length && a.addClass(u + "_txtnode"), a.children("a").attr("role", "menuitem").click(function(e) {
                o.closeOnClick && !d(e.target).parent().closest("li").hasClass(u + "_parent") && d(s.btn).click()
        ...
        }), s._visibilityToggle(s.mobileNav, null, !1, "init", !0), s.mobileNav.attr("role", "menu"), d(a).mousedown(function() {
            s._outlines(!1)
        }), d(a).keyup(function() {
            s._outlines(!0)
        }), d(s.btn).click(function(e) {
            e.preventDefault(), s._menuToggle()
        }), s.mobileNav.on("click", "." + u + "_item", function(e) {
            e.preventDefault(), s._itemClick(d(this))
        }), d(s.btn).keydown(function(e) {
            var t = e || event;
            switch (t.keyCode) {
                case r:
                case h:
                case l:
                    e.preventDefault(), t.keyCode === l && d(s.btn).hasClass(u + "_open") || s._menuToggle(), d(s.btn).next().find('[role="menuitem"]').first().focus()
            }
        }), s.mobileNav.on("keydown", "." + u + "_item", function(e) {
            switch ((e || event).keyCode) {
                case r:
                    e.preventDefault(), s._itemClick(d(e.target));
                    break;
                case m:
                    e.preventDefault(), d(e.target).parent().hasClass(u + "_collapsed") && s._itemClick(d(e.target)), d(e.target).next().find('[role="menuitem"]').first().focus()
            }
            ...
            switch ((e || event).keyCode) {
                ...
                case _:
                    ...
                    break;
                case p:
                    e.preventDefault(), d(e.target).parent().parent().parent().hasClass(u + "_open") ? ((t = d(e.target).parent().parent().prev()).focus(), s._itemClick(t)) : d(e.target).parent().parent().hasClass(u + "_nav") && (s._menuToggle(), d(s.btn).focus());
                    break;
                case c:
                    e.preventDefault(), s._menuToggle(), d(s.btn).focus()
            }
        }), o.allowParentLinks && o.nestedParentLinks && d("." + u + "_item a").click(function(e) {
        ...
        return a || (a = {}, n = (t = e.children("li")).find("a"), a.links = n.add(t.find("." + u + "_item")), e.data("menu", a)), a.links
        ...
        return void 0 === t || "object" == typeof t ? this.each(function() {
            d.data(this, "plugin_" + i) || d.data(this, "plugin_" + i, new s(this, t))
